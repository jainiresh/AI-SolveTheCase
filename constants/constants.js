export const USER_AUTH_COLLECTION_NAME =
  process.env.USER_AUTH_COLLECTION_NAME || 'Users';
export const STORY_COLLECTION_NAME =
  process.env.STORY_COLLECTION_NAME || 'Stories';
export const MONGO_URI =
  process.env.MONGO_URI ||
  'mongodb+srv://nireshpandian19:MongoDb008%40@targetdomains.a7fqocp.mongodb.net/?retryWrites=true&w=majority&appName=TargetDomains';
...
export const CONTACTS_COLLECTION_NAME =
  process.env.CONTACTS_COLLECTION_NAME || 'UserContacts';

//GEMINI SERVICE
export const GEMINI_API_KEY =
  process.env.GEMINI_API_KEY || 'AIzaSyDLHYtS6M8SbgbaGr52K6CPt1Vbm4xvffw';
export const CLOUDFLARE_API_KEY =
  process.env.CLOUDFLARE_API_KEY || 'W3v6ffHWxczZO9f1gQvyeKwcZSJsFNH_8drcDzZA';
export const CLOUDFLARE_ACCOUNT_ID =
  process.env.CLOUDFLARE_ACCOUNT_ID || '90fc83070e95f461645dd2ed67ef202d';
...
export const UPLOADCARE_PUBLIC_KEY =
  process.env.UPLOADCARE_PUBLIC_KEY || '9e3af627f3eab612be88';
...
export const pingUrl = process.env.BACK_END_URL || `http://localhost:3000`;
